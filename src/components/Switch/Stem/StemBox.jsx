...
const StemBox = ({ stem_fill }) => {
    return (
        <svg width="31" height="38" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M.5 14.6v19.35h4v2.15c0 .22.18.4.4.4h6.2a.4.4 0 00.4-.4v-1.95c0-.11.09-.2.2-.2h.1c.11 0 .2.09.2.2v.15c0 .11.09.2.2.2h1.167c.11 0 .2.09.2.2v2a.8.8 0 00.8.8h2.17a.8.8 0 00.8-.8v-2c0-.11.09-.2.2-.2H18.8a.2.2 0 00.2-.2v-.15c0-.11.09-.2.2-.2h11.43l.003-19.35a.7.7 0 00-.7-.7h-1.525a.3.3 0 01-.3-.3V1.056A.657.657 0 0027.452.4h-9.775a.29.29 0 01-.275-.2.29.29 0 00-.275-.2H13.91a.292.292 0 00-.278.2c-.04.12-.151.2-.277.2H3.647a.747.747 0 00-.747.747V13.6a.3.3 0 01-.3.3H1.2a.7.7 0 00-.7.7z" className="switch-stem" fill={stem_fill} />
