...
const HousingTopDefault = ({ housing_top_fill }) => {
    return (
        <svg width="58" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M47.24 0H10.1a1.2 1.2 0 00-1.086.692L.07 19.838a.1.1 0 00.09.142h57.02a.1.1 0 00.09-.142L48.328.692A1.2 1.2 0 0047.24 0z" className="switch-housing-top" fill={housing_top_fill} />
